...
public class TemperatureInternet extends AppCompatActivity {

    TextView textMsg, date, time, sensorId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperature_internet);
        ...
        textMsg = (TextView) this.findViewById(R.id.temperature);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        String textResult, dateResult, timeResult, sensorIdResult;
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                StringData.append(StringBuffer.substring(52, 57));
