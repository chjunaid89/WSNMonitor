...
public class SensorNode0Internet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sensor_node0_internet);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (itemText.equals("Temperature")) {
                    Intent intent = new Intent(v.getContext(), TemperatureInternet.class);
                    startActivity(intent);
                }
                if (itemText.equals("Humidity")) {
                    Intent intent = new Intent(v.getContext(), HumidityInternet.class);
                    startActivity(intent);
                }
                if (itemText.equals("Air Pressure")) {
                    Intent intent = new Intent(v.getContext(), AirPressureInternet.class);
                    startActivity(intent);
                }
                if (itemText.equals("Light Intensity")) {
                    Intent intent = new Intent(v.getContext(), LightIntensityInternet.class);
                    startActivity(intent);
                }
                if (itemText.equals("Vibration")) {
                    Intent intent = new Intent(v.getContext(), VibrationInternet.class);
                    startActivity(intent);
                }
                if (itemText.equals("Accelerometer")) {
                    Intent intent = new Intent(v.getContext(), AccelerationInternet.class);
                    startActivity(intent);
                }
