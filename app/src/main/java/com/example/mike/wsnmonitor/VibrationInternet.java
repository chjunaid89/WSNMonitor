...
public class VibrationInternet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vibration_internet);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                StringData.append(StringBuffer.substring(24, 28));
                StringData1.append(StringBuffer.substring(28, 32));
                StringData2.append(StringBuffer.substring(32, 36));
