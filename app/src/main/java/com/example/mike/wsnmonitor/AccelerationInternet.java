...
public class AccelerationInternet extends AppCompatActivity {

    TextView textMsg, textMsg1, textMsg2, date, time, sensorId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acceleration_internet);
        ...
        textMsg = (TextView) this.findViewById(R.id.x_axis_data);
        textMsg1 = (TextView) this.findViewById(R.id.y_axis_data);
        textMsg2 = (TextView) this.findViewById(R.id.z_axis_data);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        String textResult,textResult1, textResult2, dateResult, timeResult, sensorIdResult;
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                StringData.append(StringBuffer.substring(9, 14));
                StringData1.append(StringBuffer.substring(14, 19));
                StringData2.append(StringBuffer.substring(19, 24));
                ...
                textResult2 = StringData2.toString();
