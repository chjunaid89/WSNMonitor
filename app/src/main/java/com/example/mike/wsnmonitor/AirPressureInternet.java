...
public class AirPressureInternet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_pressure_internet);
        ...
        textMsg = (TextView) this.findViewById(R.id.air_pressure);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                StringData.append(StringBuffer.substring(44, 48));
