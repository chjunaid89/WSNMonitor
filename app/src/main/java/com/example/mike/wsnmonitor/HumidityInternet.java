...
public class HumidityInternet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humidity_internet);
        ...
        textMsg = (TextView) this.findViewById(R.id.humidity);
    ...
    private class MyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                StringData.append(StringBuffer.substring(48, 52));
